...
also known as the Core-Module-Sandbox pattern. However, instead of a "sandbox",
a dependency injection container is used for handling dependencies and extending
core functionality.
